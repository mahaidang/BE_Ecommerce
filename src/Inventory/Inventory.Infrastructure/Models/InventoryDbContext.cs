...
public partial class InventoryDbContext : DbContext, IInventoryDbContext
{
    ...
    DbSet<InventoryService.Domain.Entities.Warehouse> IInventoryDbContext.Warehouses => throw new NotImplementedException();

    DbSet<InventoryService.Domain.Entities.Stock> IInventoryDbContext.Stocks => throw new NotImplementedException();

    DbSet<InventoryService.Domain.Entities.StockMovement> IInventoryDbContext.StockMovements => throw new NotImplementedException();
