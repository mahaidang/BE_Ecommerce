...
public sealed class OrderingSagaConsumer : BackgroundService
{
    ...
    private readonly IServiceScopeFactory _scopeFactory; // ⬅️ dùng scope factory
    ...
    public OrderingSagaConsumer(
        ...
        IConnection conn,
        IConfiguration cfg,
        IServiceScopeFactory scopeFactory)     // ⬅️ inject scope factory, KHÔNG inject IMediator ở đây
    {
    ...
    protected override Task ExecuteAsync(CancellationToken stoppingToken)
    {
        ...
        consumer.Received += async (_, ea) =>
        {
            try
            {
                ...
                // ⬇️ MỖI MESSAGE TẠO 1 SCOPE, rồi lấy IMediator từ scope
            ...
            catch (Exception ex)
            {
                ...
                ch.BasicNack(ea.DeliveryTag, false, requeue: true); // requeue=true nếu muốn retry
            }
