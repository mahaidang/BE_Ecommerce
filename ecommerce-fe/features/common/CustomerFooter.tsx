...
const CustomerFooter = () => {
  ...
  return (
    <footer className="bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 dark:from-neutral-950 dark:via-neutral-900 dark:to-neutral-950 text-gray-300">
      {/* Main Footer */}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-2 mb-4">
              ...
              <h3 className="text-xl font-bold text-white">ShopName</h3>
            </div>
            ...
            <div className="flex gap-3 pt-2">
              ...
              <a href="#" className="w-9 h-9 rounded-full bg-gray-800 hover:bg-red-600 flex items-center justify-center transition-colors">
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <Link href="/about" className="text-gray-400 hover:text-blue-400 transition-colors flex items-center gap-2 group">
              ...
              <li>
                <Link href="/news" className="text-gray-400 hover:text-blue-400 transition-colors flex items-center gap-2 group">
                  <span className="w-1 h-1 bg-blue-500 rounded-full opacity-0 group-hover:opacity-100 transition-opacity"></span>
                  Tin tức
                </Link>
              </li>
          ...
          {/* Customer Support */}
          <div>
            <h4 className="text-white font-semibold text-lg mb-4">Hỗ trợ khách hàng</h4>
            <ul className="space-y-3">
              <li>
              ...
              <li>
                <Link href="/return" className="text-gray-400 hover:text-blue-400 transition-colors flex items-center gap-2 group">
                  <span className="w-1 h-1 bg-blue-500 rounded-full opacity-0 group-hover:opacity-100 transition-opacity"></span>
                  Đổi trả hàng
                </Link>
              </li>
              <li>
                <Link href="/warranty" className="text-gray-400 hover:text-blue-400 transition-colors flex items-center gap-2 group">
                  <span className="w-1 h-1 bg-blue-500 rounded-full opacity-0 group-hover:opacity-100 transition-opacity"></span>
                  Bảo hành
                </Link>
              </li>
              <li>
                <Link href="/payment" className="text-gray-400 hover:text-blue-400 transition-colors flex items-center gap-2 group">
                  <span className="w-1 h-1 bg-blue-500 rounded-full opacity-0 group-hover:opacity-100 transition-opacity"></span>
                  Thanh toán
                </Link>
              </li>
              <li>
                <Link href="/privacy" className="text-gray-400 hover:text-blue-400 transition-colors flex items-center gap-2 group">
                  <span className="w-1 h-1 bg-blue-500 rounded-full opacity-0 group-hover:opacity-100 transition-opacity"></span>
                  Chính sách bảo mật
                </Link>
              </li>
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-center gap-3">
                ...
                <a href="tel:+84123456789" className="text-gray-400 hover:text-blue-400 transition-colors text-sm">
                  +84 123 456 789
                </a>
              </li>
              <li className="flex items-center gap-3">
                ...
                <a href="mailto:support@shopname.com" className="text-gray-400 hover:text-blue-400 transition-colors text-sm">
